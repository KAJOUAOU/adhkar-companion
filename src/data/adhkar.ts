...
export const ADHKAR_DATA: AdhkarItem[] = [
  ...
  // ─── 1. Ayat al-Kursi ─────────────────────────────────────────────────────
  {
    ...
    category: 'protection',
    repeat: 1,
    arabic: 'ﷲُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ۚ لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ ۚ لَهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ ۗ مَن ذَا الَّذِي يَشْفَعُ عِندَهُ إِلَّا بِإِذْنِهِ ۚ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ ۖ وَلَا يُحِيطُونَ بِشَيْءٍ مِّنْ عِلْمِهِ إِلَّا بِمَا شَاءَ ۚ وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالْأَرْضَ ۖ وَلَا يَئُودُهُ حِفْظُهُمَا ۚ وَهُوَ الْعَلِيُّ الْعَظِيمُ',
  ...
  // ─── 2. Sourate Al-Ikhlâs ×3 ──────────────────────────────────────────────
  {
    ...
    category: 'praise',
    repeat: 3,
    arabic: 'بِسْمِ ﷲِ الرَّحْمَٰنِ الرَّحِيمِ\nقُلْ هُوَ ﷲُ أَحَدٌ ۝١ ﷲُ الصَّمَدُ ۝٢ لَمْ يَلِدْ وَلَمْ يُولَدْ ۝٣ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ',
  ...
  // ─── 6. Sayyid al-Istighfâr ───────────────────────────────────────────────
  {
    ...
    repeat: 1,
    arabic: 'ﷲُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ وَأَبُوءُ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ',
  ...
  // ─── 8. Protection complète — 6 directions ────────────────────────────────
  {
    ...
    category: 'protection',
    repeat: 1,
    arabic: 'ﷲُمَّ إِنِّي أَسْأَلُكَ الْعَافِيَةَ فِي الدُّنْيَا وَالآخِرَةِ، ﷲُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ فِي دِينِي وَدُنْيَايَ وَأَهْلِي وَمَالِي، ﷲُمَّ اسْتُرْ عَوْرَاتِي وَآمِنْ رَوْعَاتِي، ﷲُمَّ احْفَظْنِي مِنْ بَيْنِ يَدَيَّ وَمِنْ خَلْفِي وَعَنْ يَمِينِي وَعَنْ شِمَالِي وَمِنْ فَوْقِي، وَأَعُوذُ بِعَظَمَتِكَ أَنْ أُغْتَالَ مِنْ تَحْتِي',
  ...
  // ─── 9. Protection de l'âme et contre Satan ───────────────────────────────
  {
    ...
    category: 'protection',
    repeat: 1,
    arabic: 'ﷲُمَّ عَالِمَ الْغَيْبِ وَالشَّهَادَةِ فَاطِرَ السَّمَاوَاتِ وَالأَرْضِ رَبَّ كُلِّ شَيْءٍ وَمَلِيكَهُ، أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا أَنْتَ، أَعُوذُ بِكَ مِنْ شَرِّ نَفْسِي وَمِنْ شَرِّ الشَّيْطَانِ وَشِرْكِهِ وَأَنْ أَقْتَرِفَ عَلَى نَفْسِي سُوءًا أَوْ أَجُرَّهُ إِلَى مُسْلِمٍ',
  ...
  // ─── 10. Salât sur le Prophète ﷺ ×10 ─────────────────────────────────────
  {
    ...
    category: 'praise',
    repeat: 10,
    arabic: 'ﷲُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ',
  ...
  // ─── 12. Protection corps / ouïe / vue ×3 ─────────────────────────────────
  {
    ...
    category: 'protection',
    repeat: 3,
    arabic: 'ﷲُمَّ عَافِنِي فِي بَدَنِي، ﷲُمَّ عَافِنِي فِي سَمْعِي، ﷲُمَّ عَافِنِي فِي بَصَرِي، لَا إِلَهَ إِلَّا أَنْتَ، ﷲُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ وَالْفَقْرِ، ﷲُمَّ إِنِّي أَعُوذُ بِكَ مِنْ عَذَابِ الْقَبْرِ، لَا إِلَهَ إِلَّا أَنْتَ',
  ...
  // ─── 14. Demande de savoir et subsistance (Matin seulement) ───────────────
  {
    ...
    category: 'supplication',
    repeat: 1,
    arabic: 'ﷲُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا وَرِزْقًا طَيِّبًا وَعَمَلًا مُتَقَبَّلًا',
  ...
  // ─── 15a. Tasbîh — Subhânallâh ×100 ──────────────────────────────────────
  {
    ...
    number: 15,
    title: 'Tasbîh — Gloire et Louange à Allah',
    titleAr: 'سبحان الله وبحمده',
    period: 'both',
    category: 'praise',
    repeat: 100,
    arabic: 'سُبْحَانَ اللهِ وَبِحَمْدِهِ',
    transliteration: 'Subhâna-llâhi wa bihamdihi',
    translationFr: 'Gloire à Allah et louange à Lui',
  ...
  // ─── 15b. Tasbîh — Alhamdulillâh ×100 ────────────────────────────────────
  {
    ...
    number: 15,
    title: 'Tasbîh — Gloire au Très Grand',
    titleAr: 'سبحان الله العظيم وبحمده',
    period: 'both',
    category: 'praise',
    repeat: 100,
    arabic: 'سُبْحَانَ اللهِ الْعَظِيمِ وَبِحَمْدِهِ',
    transliteration: "Subhâna-llâhi l-'Azîmi wa bihamdihi",
    translationFr: 'Gloire au Très Grand Allah et louange à Lui',
    translationEn: 'Glory be to Allah the Almighty and praise be to Him',
  ...
  // ─── 15c. Tasbîh — Allâhou Akbar ×100 ────────────────────────────────────
  {
    ...
    number: 15,
    title: 'Tasbîh complet — Les paroles aimées d\'Allah',
    titleAr: 'سبحان الله والحمد لله والله أكبر',
    period: 'both',
    category: 'praise',
    repeat: 100,
    arabic: 'سُبْحَانَ اللهِ، الْحَمْدُ لِلَّهِ، اللهُ أَكْبَرُ، لَا إِلَهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ',
    transliteration: "Subhâna-llâhi, al-hamdu li-llâhi, Allâhou Akbar, lâ ilâha illa-llâhou wahdahou lâ charîka lah, lahou l-moulkou wa lahou l-hamd, wa houwa 'alâ koulli chay'in qadîr.",
    translationFr: "Gloire à Allah, la louange est à Allah, Allah est le Plus Grand. Il n'y a de divinité qu'Allah, Seul, sans associé. À Lui la royauté et la louange, et Il est Puissant sur toute chose.",
    translationEn: "Glory be to Allah, praise be to Allah, Allah is the Greatest. There is no deity except Allah, alone, without partner. To Him belongs all sovereignty and praise, and He is capable of all things.",
    merit: "Ces formules sont les paroles les plus aimées d'Allah selon le Prophète ﷺ, les plus légères pour la langue mais les plus lourdes dans la balance des bonnes actions.",
    meritEn: "These formulas are the words most beloved to Allah according to the Prophet ﷺ, lightest on the tongue but heaviest in the scales of good deeds.",
    source: 'Bukhari et Muslim',
    tags: ['gratitude', 'foi', 'baraka'],
  ...
  // ─── 17. Asbahnâ bika (Matin) ─────────────────────────────────────────────
  {
    ...
    category: 'morning',
    repeat: 1,
    arabic: 'ﷲُمَّ بِكَ أَصْبَحْنَا وَبِكَ أَمْسَيْنَا وَبِكَ نَحْيَا وَبِكَ نَمُوتُ وَإِلَيْكَ النُّشُورُ',
  ...
  // ─── 19. Témoin de foi — Matin ×4 ─────────────────────────────────────────
  {
    ...
    category: 'faith',
    repeat: 4,
    arabic: 'ﷲُمَّ إِنِّي أَصْبَحْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ عَرْشِكَ وَمَلَائِكَتَكَ وَجَمِيعَ خَلْقِكَ أَنَّكَ أَنْتَ اللهُ لَا إِلَهَ إِلَّا أَنْتَ وَحْدَكَ لَا شَرِيكَ لَكَ وَأَنَّ مُحَمَّدًا عَبْدُكَ وَرَسُولُكَ',
  ...
  // ─── 22. Asbahnâ wa asbahal-mulk Rabb al-alameen (Matin) ──────────────────
  {
    ...
    category: 'morning',
    repeat: 1,
    arabic: 'أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ رَبِّ الْعَالَمِينَ، ﷲُمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَا الْيَوْمِ فَتْحَهُ وَنَصْرَهُ وَنُورَهُ وَبَرَكَتَهُ وَهُدَاهُ وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِيهِ وَشَرِّ مَا بَعْدَهُ',
  ...
  // ─── Salât Ibrahimiya ─────────────────────────────────────────────────────
  {
    ...
    category: 'praise',
    repeat: 1,
    arabic: 'ﷲُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ وَعَلَىٰ آلِ مُحَمَّدٍ كَمَا صَلَّيْتَ عَلَىٰ إِبْرَاهِيمَ وَعَلَىٰ آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ ﷲُمَّ بَارِكْ عَلَىٰ مُحَمَّدٍ وَعَلَىٰ آلِ مُحَمَّدٍ كَمَا بَارَكْتَ عَلَىٰ إِبْرَاهِيمَ وَعَلَىٰ آلِ إِبْرَاهِيمَ إِنَّكَ حَمِيدٌ مَجِيدٌ',
