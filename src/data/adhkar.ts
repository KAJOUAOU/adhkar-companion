...
export const ADHKAR_DATA: AdhkarItem[] = [
  ...
  // ─── 15c. Tasbîh — Allâhou Akbar ×100 ────────────────────────────────────
  {
    ...
    category: 'praise',
    repeat: 100,
    arabic: 'سُبْحَانَ اللهِ، وَالْحَمْدُ لِلَّهِ، وَاللهُ أَكْبَرُ، لَا إِلَهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ',
    transliteration: "Subhâna-llâhi, wal-hamdu li-llâhi, wa-llâhou Akbar, lâ ilâha illa-llâhou wahdahou lâ charîka lah, lahou l-moulkou wa lahou l-hamd, wa houwa 'alâ koulli chay'in qadîr.",
